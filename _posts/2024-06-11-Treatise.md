...
mlm = 2.6 + 0.13 _ level_diff
if ( mlm > 3.0 ) then
mlm = 3.0
end
else if ( player_level > 50 ) then
base = 1.0 + (player_level - 50) _ 0.16
scale = 0.013 _ (player_level - 50)
if ( level_diff > 0 ) then
scale = scale / 2
end
mlm = base + scale _ level_diff
end
...
[https://drive.google.com/file/d/1DH\_...usp=drive_link](https://drive.google.com/file/d/1DH_vqtoLp4_iDyYUMhJbtl2XhGsO9WNd/view?usp=drive_link)
